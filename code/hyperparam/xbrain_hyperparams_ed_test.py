def xbrain_hyperparams_ed_test(pthresh, ballsz_start,ballsz_small, ballsz_large,presid, bgfg, fileName, errFile, paintOut, inData, pData, probData, mapData, nmapData, vmapData, centroidOut, outfilename)
