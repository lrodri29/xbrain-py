def xbrain_hyperparams(pthresh, ballsz_start,ballsz_small, ballsz_large,presid, bgfg, fileName, errFile, paintFile, inData, pData, probData, mapData, nmapData, vmapData, centroidOut, outfilename):
    print('test')
%% Setup
