pthresh = map(lambda x: x/100.0, range(50,70,5))
...
pthresh_file = 'pthresh_file7.list'
ballsz_init_file = 'ballsz_init_file7.list'
ballsz_small_file = 'ballsz_small_file7.list'
ballsz_large_file = 'ballsz_large_file7.list'
presid_file = 'presid_file7.list'
bgfg_mode_file = 'bgfg_mode_file7.list'
fname = 'filenames7.list'
